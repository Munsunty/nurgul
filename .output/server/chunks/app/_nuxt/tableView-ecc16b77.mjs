import { ref, resolveComponent, mergeProps, withCtx, unref, createVNode, isRef, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Toolbar, null, {
        start: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><i class="pi pi-bars p-toolbar-separator mr-2" data-v-9414e57d${_scopeId}></i>`);
      ...
      _push(`<div style="${ssrRenderStyle({})}" data-v-9414e57d>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_Column, {
              field: "partName",
              header: "\uD488\uBA85",
              style: { "min-width": "300px", "justify-content": "center" }
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_Column, {
              field: "spec",
              header: "\uC2A4\uD399",
...
const tableView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9414e57d"]]);

export { tableView as default };
//# sourceMappingURL=tableView-ecc16b77.mjs.map
